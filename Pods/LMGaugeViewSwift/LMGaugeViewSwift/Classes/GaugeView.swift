...
open class GaugeView: UIView {
    ...
    @IBInspectable public var valueRingColor: UIColor = UIColor(red: 76.0/255, green: 217.0/255, blue: 100.0/255, alpha: 1)
    ...
    public func strokeGauge() {
        ...
        if let delegate = delegate {
            valueRingColor = delegate.ringStokeColor(gaugeView: self, value: value)
        }
        progressLayer.strokeColor = valueRingColor.cgColor
    }
}
